...
urlpatterns = [
    ...
    path('bootstrap4f/categories', views.bootstrap4f, name='bootstrap4fCategories'),
    path('bootstrap4f/details', views.bootstrap4f, name='bootstrap4fDetails'),
    path('bootstrap4f/login', views.bootstrap4f, name='bootstrap4fLogin'),
    path('bootstrap4f/posts', views.bootstrap4f, name='bootstrap4fPosts'),
    path('bootstrap4f/profile', views.bootstrap4f, name='bootstrap4fProfile'),
    path('bootstrap4f/settings', views.bootstrap4f, name='bootstrap4fSettings'),
    path('bootstrap4f/users', views.bootstrap4f, name='bootstrap4fUsers'),
